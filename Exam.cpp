...
void Exam::setNum(int num) { this->num = num; }
...
string Exam::getDes() { return std::string(this->description); }
string Exam::getHint() { return std::string(this->hint); }
string Exam::getAnswer() { return std::string(this->answer); }
